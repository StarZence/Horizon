...
import net.mcreator.overthehorizon.procedures.SteelRepeaterRangedItemUsedProcedure;
...
public class SteelRepeaterItem extends OverthehorizonModElements.ModElement {
	@ObjectHolder("overthehorizon:steel_repeater")
	public static final Item block = null;
	@ObjectHolder("overthehorizon:entitybulletsteel_repeater")
	public static final EntityType arrow = null;
	public SteelRepeaterItem(OverthehorizonModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletsteel_repeater").setRegistryName("entitybulletsteel_repeater"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("steel_repeater");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Has a 30% chance not to consume arrows"));
			list.add(new StringTextComponent("Makes you go pew pew pew"));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.7f, 3, 1);
						...
						}
						{
							...
							SteelRepeaterRangedItemUsedProcedure.executeProcedure($_dependencies);
						}
					}
