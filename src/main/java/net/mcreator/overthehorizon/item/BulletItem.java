...
public class BulletItem extends OverthehorizonModElements.ModElement {
	@ObjectHolder("overthehorizon:bullet")
	public static final Item block = null;
	public BulletItem(OverthehorizonModElements instance) {
		super(instance, 9);
	}
