...
import net.mcreator.overthehorizon.item.TinItem;
...
public class TinoreBlock extends OverthehorizonModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(4f, 20f).lightValue(0).harvestLevel(2)
